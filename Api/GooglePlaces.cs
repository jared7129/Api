using Api.Entities.Places.AutoComplete.Request;
using Api.Entities.Places.AutoComplete.Response;
using Api.Entities.Places.Details.Request;
using Api.Entities.Places.Details.Response;
using Api.Entities.Places.Photos.Request;
using Api.Entities.Places.Photos.Response;
using Api.Entities.Places.QueryAutoComplete.Request;
using Api.Entities.Places.QueryAutoComplete.Response;
using Api.Entities.Places.Search.Find.Request;
using Api.Entities.Places.Search.Find.Response;
using Api.Entities.Places.Search.NearBy.Request;
using Api.Entities.Places.Search.NearBy.Response;
using Api.Entities.Places.Search.Text.Request;
using Api.Entities.Places.Search.Text.Response;
